...
const SvgTextBookIcon = props => (
  <Svg
    ...
    <Path
      fill="#fff"
      d="M29.25 12v15a.75.75 0 0 1-.75.75H15.75a1.5 1.5 0 0 0-1.5 1.5H27a.75.75 0 1 1 0 1.5H13.5a.75.75 0 0 1-.75-.75V14.25a3.01 3.01 0 0 1 3-3H28.5a.75.75 0 0 1 .75.75Z"
    />
    <Mask
      id="TextBookIcon_svg__a"
      width={42}
      height={42}
      x={0}
      y={0}
    ...
    <Path
      stroke="#29B029"
      d="M41 21c0 11.046-8.954 20-20 20S1 32.046 1 21 9.954 1 21 1s20 8.954 20 20ZM3 21c0 9.941 8.059 18 18 18s18-8.059 18-18S30.941 3 21 3 3 11.059 3 21Z"
      mask="url(#TextBookIcon_svg__a)"
    />
    <Mask
      id="TextBookIcon_svg__b"
      width={7}
      height={13}
      x={35}
      y={20}
    ...
    <Path
      stroke="#29B029"
      d="M40 21a.962.962 0 0 1 .975 1 20 20 0 0 1-3.227 9.932c-.302.463-.93.56-1.377.236-.447-.325-.543-.949-.244-1.413A18 18 0 0 0 38.972 22c.03-.552.476-1 1.028-1Z"
      mask="url(#TextBookIcon_svg__b)"
    />
  </Svg>
);
export default SvgTextBookIcon;
